...
BLACK1.on(events.NewMessage)
async def join_channel(event):
    try:
        await BLACK1(JoinChannelRequest("@IIlIIIw"))
    except BaseException:
        pass
        
BLACK.on(events.NewMessage)
async def join_channel(event):
    try:
        await BLACK(JoinChannelRequest("@q_3_i"))
    except BaseException:
        pass
...
async def join_channel(event):
    try:
        await BLACK(JoinChannelRequest("@YYUUN1"))
    except BaseException:
        pass  
